...
pub async fn get_all_heats(db: web::Data<Pool>) -> Result<web::Json<Vec<Heat>>> {
...
pub async fn get_heat_by_id(web::Path(heat_id): web::Path<u32>, db: web::Data<Pool>) -> Result<web::Json<Option<Heat>>> {
